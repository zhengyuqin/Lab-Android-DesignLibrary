...
public class ScrollableHelper {
	...
	public boolean isTop() {
		...
		if (scrollableView == null) {
			throw new NullPointerException("You should call ScrollableHelper.setCurrentScrollableContainer() to set " +
					"ScrollableContainer.");
		}
	...
	private static boolean isRecyclerViewTop(RecyclerView recyclerView) {
		if (recyclerView != null) {
			...
			if (layoutManager instanceof LinearLayoutManager) {
				...
				Log.d("scrollableLayout1", "recyclerView:" + recyclerView + "firstVisibleItemPosition:" +
